jQuery(function($) {
  ...
  $('#id-checkbox-disable-it').on('click', function() {
  ...
  $('#tooltip-1').tooltip({
    container: 'body',
    template: '<div class="tooltip" role="tooltip"><div class="arrow brc-success"></div><div class="bgc-success tooltip-inner text-dark-tp4 text-110 px-2 pb-2"></div></div>'
  });
  $('#popover-1').popover({
    container: 'body',
    trigger: 'click',
  ...
  $(slider1).find('.noUi-handle').addClass('brc-success slider-bars-h').end()
            .find('.noUi-connect').addClass('bgc-success').end()
            .find('.noUi-tooltip').addClass('opacity-1 bgc-success brc-success text-white radius-3 px-3');
  ...
  $(slider2).find('.noUi-handle').addClass('brc-info border-2 radius-round slider-bars-none').end()
  ...
  .find('.noUi-connect').addClass('bgc-warning-m1').end()
  ...
  $(slider3).find('.noUi-handle').addClass('border-3 brc-purple-tp2 bgc-white-tp1 radius-1').end()
  //.find('.noUi-base').addClass('bgc-yellow-m2').end()
  .find('.noUi-connect').addClass('bgc-purple-tp2').end()
  .find('.noUi-tooltip').addClass('bgc-dark-tp1 text-white border-0 text-90 radius-1 px-2');
  ...
  var dp2 = TinyDatePicker('#id-date-2', {
     mode: 'dp-modal',
  }).on('statechange', function(ev) {
    //console.log(ev);
  });
  ...
  $('#id-timepicker').on('dp.show', function() {
  ...
  // time picker inside a popover
  $('#id-popover-timepicker').popover({
    title: 'Choose Time',
    sanitize: false,
    content: function() {
