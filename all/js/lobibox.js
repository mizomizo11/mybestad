...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        soundPath: '/all/js/sounds/',   // The folder path where sounds are located
        soundExt: '.ogv',           // Default extension for all sounds
        ...
        delay: 2000,                // Hide notification after this time (in miliseconds)
