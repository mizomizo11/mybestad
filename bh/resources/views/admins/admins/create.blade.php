    ...
    <div class="content-nav mb-1 bgc-grey-l4">
        <div class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb pl-2">
                ...
                <li class="breadcrumb-item active text-grey-d1" ><a href="{{url(app()->getLocale().'/admins/admins/') }}"> ادارة المستخدمين</a></li>
...
@endif
<form  method="POST" action="{{url(app()->getLocale())}}/admins/admins/store"  enctype="multipart/form-data"  >
@csrf
        <div class='row' >
            <div class='col-md-2'>
                <div>
