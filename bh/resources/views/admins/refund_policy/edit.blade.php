...
<form  method="POST"  id="postForm"  action="{{route('refund_policy_update',['locale' => app()->getLocale()]) }}"  enctype="multipart/form-data"  style="">
    @csrf
    <input  type="hidden" class="form-control" name="id" value="{{ $refund_policy -> id }}"   size="44" style="" />

    <div class='row' style="margin-top: 20px;">
        <div class='col-md-12'>
            <h6 style="">سياسة الخصوصية - عربي  </h6>
            <textarea id="details_ar"  name="details_ar" style="height: 300px;width: 100%">
                    {!! $refund_policy -> details_ar !!}
            </textarea>
{{--            <script>--}}
