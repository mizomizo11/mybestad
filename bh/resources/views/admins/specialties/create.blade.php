...
@endsection
@section('content')
    <form  method="POST" action="{{url(app()->getLocale().'/admins/specialties/store') }}"  enctype="multipart/form-data"  style="">
    @csrf
        <div class='row' >
            <div class='col-md-3'>
                <div>
            ...
            <div class='col-md-2'>
                <div >
                    ...
                    <input type="number"  class="form-control" name="price"   style="direction: ltr;text-align: left" />
                </div>
            </div>
        ...
        <div class='row' style="margin-top: 65px;">
            <div class='col-md-6'>
                ...
                <textarea    name="details_ar"  class="form-control" ></textarea>
            </div>
            <div class='col-md-6'>
                <label >وصف - انكليزي</label>
                <textarea    name="details_en"  class="form-control" ></textarea>
            </div>
        </div>
