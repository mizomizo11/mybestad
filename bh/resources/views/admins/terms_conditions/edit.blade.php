    ...
    <div class="content-nav mb-1 bgc-grey-l4">
        <div class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb pl-2">
                ...
                <li class="breadcrumb-item active text-grey-d1" >ادارة   الشروط والاحكام </li>
...
{{--    <script src="{{  asset('all/richtexteditor/plugins/all_plugins.js')}}"></script>--}}
    ...
    <form  method="POST"  id="postForm"  action="{{route('terms_conditions_update',['locale' => app()->getLocale()]) }}"  enctype="multipart/form-data"  style="">
    @csrf
    <input  type="hidden" class="form-control" name="id" value="{{ $terms_conditions -> id }}"   size="44" style="" />

    <div class='row' style="margin-top: 20px;">
        <div class='col-md-12'>
            <h6 style="">11  الشروط والاحكام - عربي  </h6>
...
{{--            </script>--}}
        ...
        <div class='col-md-12' style="margin-top: 50px">
            <h6 style=""> الشروط والاحكام - انكليزي </h6>
