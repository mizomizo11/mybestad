...
@section('content')
    ...
    <form  method="POST" action="{{route('timezone-store',["locale"=>app()->getLocale()]) }}"  enctype="multipart/form-data"  style="">
        ...
        <div class='row' >
            ...
            <div class='col-md-3'>
                <div >
                    ...
                    <input   class="form-control form-control-sm"  name="name_en"  style="text-align: left;direction: ltr;"  />
                </div>
            </div>
            <div class='col-md-3'>
                <div >
                    <label>utc_offset </label>
                    <input   class="form-control form-control-sm"  name="utc_offset"  style="text-align: left;direction: ltr;"  />
                </div>
            </div>
        </div>
