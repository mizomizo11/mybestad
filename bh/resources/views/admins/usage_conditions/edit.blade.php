    ...
    <div class="content-nav mb-1 bgc-grey-l4">
        <div class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb pl-2">
                ...
                <li class="breadcrumb-item active text-grey-d1" >ادارة  شروط الاستخدام </li>
...
{{--    <script src="{{  asset('all/richtexteditor/plugins/all_plugins.js')}}"></script>--}}
    ...
    <form  method="POST"  id="postForm"  action="{{route('usage_conditions_update',['locale' => app()->getLocale()]) }}"  enctype="multipart/form-data"  style="">
    @csrf
    <input  type="hidden" class="form-control" name="id" value="{{ $usage_conditions -> id }}"   size="44" style="" />

    <div class='row' style="margin-top: 20px;">
        <div class='col-md-12'>
            <h6 style=""> شروط الاستخدام - عربي  </h6>
            <textarea id="details_ar"  name="details_ar" style="direction: rtl;text-align: right;height: 300px;width: 100%">
                    {!! $usage_conditions -> details_ar !!}
            </textarea>
...
{{--            </script>--}}
        ...
        <div class='col-md-12' style="margin-top: 50px">
            <h6 style=""> شروط الاستخدام - انكليزي </h6>
            <textarea id="details_en" style="text-align: left;height: 300px;width: 100%" name="details_en">
                    {{$usage_conditions -> details_en}}
            </textarea>
{{--            <script>--}}
