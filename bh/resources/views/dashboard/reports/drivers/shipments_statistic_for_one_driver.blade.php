    ...
    <div class="content-nav mb-1 bgc-grey-l4 noprint">
        <div class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb pl-2">
                ...
                <li class="breadcrumb-item active color1" ><a href="{{url('/dashboard/reports/drivers/')}}" > السائقين </a>  </li>
{{--                <li class="breadcrumb-item active color1" ><a href="{{url('/dashboard/reports/accounts/')}}" > العملاء </a>  </li>--}}
                <li class="breadcrumb-item active text-grey-d1">تقرير عدد الشحنات للسائق </li>

                <li class="breadcrumb-item active text-grey-d1"> {{$user->name}} </li>
            </ol>
...
@section('content')
    ...
    <form class="noprint" name="form1" method="get"  action="{{url("/dashboard/reports/drivers/$driver_id")}}">
