    ...
    <div class="content-nav mb-1 bgc-grey-l4 noprint">
        <div class="d-flex justify-content-between align-items-center">
            <ol class="breadcrumb pl-2">
                ...
                <li class="breadcrumb-item active text-grey-d1">تقرير عدد الشحنات لشركة ارابيكس</li>
            </ol>
...
{{--    <form class="noprint" name="form1" method="get"  action="{{url("/dashboard/accounting/accounts/postpaid_account_statment/")}}">--}}
    <form class="noprint" name="form1" method="get"  action="{{url("/dashboard/reports/shipments_count/")}}">
