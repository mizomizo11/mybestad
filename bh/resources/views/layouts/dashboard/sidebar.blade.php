    ...
    <div class="sidebar-inner">
        ...
        <div class="ace-scroll flex-grow-1" ace-scroll>
            ...
            <ul class="nav has-active-border col-md-12" role="navigation" aria-label="Main">
                ...
                @php
                    if (in_array("cp_manage", session('permissions_array')) or in_array("administrator", session('permissions_array')))
                    {
...
{{--                @if(in_array("users_show", session('permissions_array')) or in_array("administrator", session('permissions_array')))--}}
                    <li class="nav-item " style="text-align: right">
