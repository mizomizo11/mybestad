                ...
                <div class="carousel-inner">
                    @foreach ($carousels as $carousel5)
                        <div class="carousel-item @if($loop->index==0 ) active @endif">
                            ...
                            <div  class="carousel-caption animate__animated animate__fadeIn" data-aos="flip-left" style="top: 40% ;bottom: auto;background-color: {{ $settings->primary_color }}88">

                                <h1 style="font-weight: bold;color: #fff" class="animate__animated  animate__fadeInUp animate__slow">
                                    {{ $carousel5->{'name_'.app()->getLocale()} }}
                                </h1>
                                <h2 style="color: #fff" class="animate__animated animate__fadeInUp animate__slow">
