    ...
    <div class="container" style=";padding-top: 50px;margin-bottom: 50px;text-align: @if(App::getLocale() == 'ar')  right  @else  left   @endif ;direction: @if(App::getLocale() == 'ar')  rtl  @else  ltr   @endif ">
        <div class="row">
            <div class="col-md-6" style="margin: auto">
                ...
                <form id="form11"     enctype="multipart/form-data" >
                    @csrf
                    <div class='row' style="padding-top: 20px;">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="name" value="{{$customer->name}}" id="name"   class="form-control form-control-sm"  required=""  />
                        </div>
                    ...
                    <div class='row' style="margin-top: 5px;">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="mobile" value="{{$customer->mobile}}" style="direction: ltr;text-align: left" class="form-control form-control-sm"  required=""  />
                        </div>
                    </div>
                    <div class='row' style="margin-top: 5px;">
                        <div class='col-md-4'>
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="phone" value="{{$customer->phone}}" style="direction: ltr;text-align: left" class="form-control form-control-sm"  required=""  />
                        </div>
                    </div>
                    <div class='row' style="margin-top: 5px;">
                        <div class='col-md-4'>
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="email" value="{{$customer->email}}" style="direction: ltr;text-align: left" class="form-control form-control-sm" required=""    />
                        </div>
                    ...
                    <div class='row' style="margin-top: 5px;">
                        ...
                        <div class='col-md-6'>
                            <input type="text" name="password" value="{{$customer->pass}}" style="direction: ltr;text-align: left" class="form-control form-control-sm" required=""    />
                        </div>
                    </div>
                    <div class='row' style="margin-top: 5px;">
                        <div class='col-md-4'>
                        ...
                        <div class='col-md-6'>
                            <input  type="text" name="password2" value="{{$customer->pass}}" style="direction: ltr;text-align: left" class="form-control form-control-sm"  required=""  />
                        </div>
                    </div>
...
{{--                            </select>--}}
                            ...
                            <select id="" name="countries_id" class="form-control form-control-sm" style="border-radius:5px">
                                @foreach ($countries as $country)
                                    @if ($country -> id == $customer -> countries_id)
                ...
                $.ajax(
                    {
                        ...
                        url:"{{url(app()->getLocale()."/customers/update")}}",
