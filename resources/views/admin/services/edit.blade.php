...
<div class="container-fluid">
    <div class="mb-4">
        <h2><i class="fas fa-edit"></i> {{ __('services.edit_service') }}</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.services.update', $service) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                  id="description_en" 
                                  name="description_en" 
                                  rows="4">{{ old('description_en', $service->description_en) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                  id="description_ar" 
                                  name="description_ar" 
                                  rows="4">{{ old('description_ar', $service->description_ar) }}</textarea>
                ...
                <!-- Image Upload -->
                <div class="mb-3">
                    <label for="image" class="form-label">{{ __('services.image') }} @if($service->image_path)(Replace)@endif</label>
                    <input type="file" 
